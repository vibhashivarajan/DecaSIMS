...
/**
 * The Class LoginSecurityConfig: Class belonging to spring framework to load & authenticate user login.
 * Each and every url access in this web-applicaton will be blocked unless the user is authenticated.
